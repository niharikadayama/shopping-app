...
const ItemDetail = ({navigation,route}) =>{
    ...
    return (
        <SafeAreaView style={styles.container}> 
            ...
            <Icon name="ios-chevron-back" size={26} color={Colors.white} style={styles.icon}
            ...
            <View style={styles.detailsContainer}>
                ...
                <Icon name="heart" size={25} style={styles.detailHeart}
                onPress={()=>{
                ...
                <View style={styles.detailColor}>
                    ...
                    <Icon name="ios-help-circle-sharp" size={40} color={Colors.yellow}/>
